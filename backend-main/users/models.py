...
class User(AbstractUser, BaseModel):
    ...
    dietary_preferences = models.CharField(max_length=255, null=True, blank=True)  # e.g., vegetarian, vegan, keto, etc.
    allergies = models.CharField(max_length=255, null=True, blank=True)  # e.g., dairy, nuts, gluten, etc.
    ...
    def suggested_calories(self):
        if self.age and self.gender and self.height and self.weight and self.activity_level:
