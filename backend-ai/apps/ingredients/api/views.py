...
from apps.meal.models import RecipeIngredient
...
class IngredientListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        return Ingredient.objects.all()[:50]
...
class RecipeIngredientListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        recipe_uuid = self.kwargs.get('recipe_id')
        return RecipeIngredient.objects.filter(recipe__id=recipe_uuid)
