...
class UserAdmin(BaseUserAdmin, ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Personal info", {"fields": ("first_name", "last_name", "age", "height", "weight", "gender")}),
        ("Health Information", {"fields": ("goal", "allergies", "activity_level")}),
        ("Nutrition Information", {"fields": ("calories", "proteins", "carbs", "fats")}),
